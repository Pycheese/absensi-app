        ...
        <div class="px-5 pt-14 pb-10 text-white relative">
            ...
            <div class="flex gap-3 mt-10 overflow-x-auto no-scrollbar scroll-smooth pb-1 snap-x snap-mandatory">
                ...
                @foreach($calendarDays as $day)
                        ...
                        <a href="{{ route('schedule.index', ['date' => $day->format('Y-m-d')]) }}"
                            class="snap-start relative min-w-[74px] h-[104px]
                                                                                    transition-all duration-200
                                                                                    {{ $isSelected
                    ? 'bg-white border border-[#1A3764]'
                    : 'bg-white/20 border border-white/10'
                            ...
                            <p
                                class="text-[42px] leading-none font-light
                                                                                        {{ $isSelected ? 'text-[#2FC3E6]' : 'text-white' }}">
